...
class Test(unittest.TestCase):
    def test_0(self):
        ...
        self.assertRaises(
            ValueError,
            lambda: TrajectoryIterator(["./data/md1_prod.Tc5b.x" for _ in range(N)]))
        ...
        # raise ValueError
        self.assertRaises(
            ValueError, lambda: TrajectoryIterator("./data/Tc5b.top"))
    ...
    def test_1(self):
        ...
        self.assertRaises(
            TypeError,
            lambda: pt.io.iterload(["./data/md1_prod.Tc5b.x" for _ in range(N)], "./data/Tc5b.top", [(0, 5), (3, 8)]))
