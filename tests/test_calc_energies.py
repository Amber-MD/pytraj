    ...
    try:
        ...
        def test_4(self):
            ...
            if amberhome:
                ...
                edict = pyca.energy_decomposition(traj=traj, input_options=options, qmmm_options=qmmm_options)
        ...
        def test_5(self):
            ...
            if amberhome:
                topfile = os.path.join(amberhome, "test/qmmm2/MechEm_nma-spcfwbox/prmtop")
                rstfile = os.path.join(amberhome, "test/qmmm2/MechEm_nma-spcfwbox/inpcrd")
                traj = mdio.load(rstfile, topfile)
        ...
        print ("does not have sanderapi/chemistry package. skip test")
