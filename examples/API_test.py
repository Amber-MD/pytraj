...
state = create_state(top="../tests/data/Tc5b.top", 
                     trajin="../tests/data/md1_prod.Tc5b.x", ref=None)
...
cppout = np.loadtxt("../tests/data/CAres2_CAres10.Tc5b.dat", skiprows=1).transpose()[1]
print(cppout[:10])
