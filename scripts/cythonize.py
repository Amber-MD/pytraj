# (pytraj note): adapted from scipy package
#!/usr/bin/env python
""" cythonize
...
https://raw.github.com/dagss/private-pytraj-refactor/cythonize/cythonize.py
...
def process_tempita_pyx(fromfile, tofile):
    try:
        ...
        raise Exception('Building pytraj requires Tempita: '
