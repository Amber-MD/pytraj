...
static int __pyx_pf_6pytraj_4Grid_4Grid___cinit__(struct __pyx_obj_6pytraj_4Grid_Grid *__pyx_v_self); /* proto */
...
static int __pyx_pw_6pytraj_4Grid_4Grid_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_6pytraj_4Grid_4Grid___cinit__(((struct __pyx_obj_6pytraj_4Grid_Grid *)__pyx_v_self));
...
static int __pyx_pf_6pytraj_4Grid_4Grid___cinit__(struct __pyx_obj_6pytraj_4Grid_Grid *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
static PyObject *__pyx_tp_new_6pytraj_4Grid_Grid(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_6pytraj_4Grid_4Grid_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6pytraj_4Grid_Grid) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_4Grid_Grid.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Grid", (PyObject *)&__pyx_type_6pytraj_4Grid_Grid) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
