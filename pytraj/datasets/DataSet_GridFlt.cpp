...
#endif
{
  ...
  __pyx_ptype_6pytraj_9math_dot_Grid_Grid = __Pyx_ImportType("pytraj.math.Grid", "Grid", sizeof(struct __pyx_obj_6pytraj_9math_dot_Grid_Grid), 1); if (unlikely(!__pyx_ptype_6pytraj_9math_dot_Grid_Grid)) {__pyx_filename = __pyx_f[7]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
