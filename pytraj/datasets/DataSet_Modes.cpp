...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pytraj.datasets.DataSet_Modes")) {
      if (unlikely(PyDict_SetItemString(modules, "pytraj.datasets.DataSet_Modes", __pyx_m) < 0)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  __pyx_ptype_6pytraj_8datasets_7DataSet_DataSet = __Pyx_ImportType("pytraj.datasets.DataSet", "DataSet", sizeof(struct __pyx_obj_6pytraj_8datasets_7DataSet_DataSet), 1); if (unlikely(!__pyx_ptype_6pytraj_8datasets_7DataSet_DataSet)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_8datasets_13DataSet_Modes_DataSet_Modes.tp_base = __pyx_ptype_6pytraj_8datasets_7DataSet_DataSet;
  if (PyType_Ready(&__pyx_type_6pytraj_8datasets_13DataSet_Modes_DataSet_Modes) < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_8datasets_13DataSet_Modes_DataSet_Modes.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "DataSet_Modes", (PyObject *)&__pyx_type_6pytraj_8datasets_13DataSet_Modes_DataSet_Modes) < 0) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
