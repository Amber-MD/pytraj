# (pytraj note): copied and changed a bit from scipy package
# TODO (pytraj) : add more info about license
# we copied this file here so we don't need to install whole scipy package
...
from pytraj.externals.six import integer_types, text_type, binary_type
