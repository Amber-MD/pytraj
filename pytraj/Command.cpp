...
static PyObject *__pyx_pf_6pytraj_7Command_7Command_4get_state(CYTHON_UNUSED PyObject *__pyx_v_cls, PyObject *__pyx_v_trajin_text); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6pytraj_7Command_7Command_5get_state(PyObject *__pyx_v_cls, PyObject *__pyx_v_trajin_text); /*proto*/
static char __pyx_doc_6pytraj_7Command_7Command_4get_state[] = "Command.get_state(type cls, trajin_text)";
static PyObject *__pyx_pw_6pytraj_7Command_7Command_5get_state(PyObject *__pyx_v_cls, PyObject *__pyx_v_trajin_text) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_state (wrapper)", 0);
  __pyx_r = __pyx_pf_6pytraj_7Command_7Command_4get_state(((PyObject*)__pyx_v_cls), ((PyObject *)__pyx_v_trajin_text));
...
static PyObject *__pyx_pf_6pytraj_7Command_7Command_4get_state(CYTHON_UNUSED PyObject *__pyx_v_cls, PyObject *__pyx_v_trajin_text) {
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_6pytraj_12CpptrajState_CpptrajState)), __pyx_empty_tuple, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_cppstate = ((struct __pyx_obj_6pytraj_12CpptrajState_CpptrajState *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "pytraj/Command.pyx":28
 *     def get_state(cls, trajin_text):
 *         cdef CpptrajState cppstate = CpptrajState()
 *         trajin_text = trajin_text.encode()             # <<<<<<<<<<<<<<
 *         _Command.ProcessInput(cppstate.thisptr[0], trajin_text)
 ...
 */
  ...
  __Pyx_AddTraceback("pytraj.Command.Command.get_state", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyMethodDef __pyx_methods_6pytraj_7Command_Command[] = {
  {"get_state", (PyCFunction)__pyx_pw_6pytraj_7Command_7Command_5get_state, METH_O, __pyx_doc_6pytraj_7Command_7Command_4get_state},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6pytraj_7Command_Command) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_7Command_Command.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Command", (PyObject *)&__pyx_type_6pytraj_7Command_Command) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_6pytraj_10TrajinList_TrajinList = __Pyx_ImportType("pytraj.TrajinList", "TrajinList", sizeof(struct __pyx_obj_6pytraj_10TrajinList_TrajinList), 1); if (unlikely(!__pyx_ptype_6pytraj_10TrajinList_TrajinList)) {__pyx_filename = __pyx_f[22]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_8datasets_7DataSet_DataSet = __Pyx_ImportType("pytraj.datasets.DataSet", "DataSet", sizeof(struct __pyx_obj_6pytraj_8datasets_7DataSet_DataSet), 1); if (unlikely(!__pyx_ptype_6pytraj_8datasets_7DataSet_DataSet)) {__pyx_filename = __pyx_f[23]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_11DataSetList_DataSetList = __Pyx_ImportType("pytraj.DataSetList", "DataSetList", sizeof(struct __pyx_obj_6pytraj_11DataSetList_DataSetList), 1); if (unlikely(!__pyx_ptype_6pytraj_11DataSetList_DataSetList)) {__pyx_filename = __pyx_f[24]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_11CpptrajFile_CpptrajFile = __Pyx_ImportType("pytraj.CpptrajFile", "CpptrajFile", sizeof(struct __pyx_obj_6pytraj_11CpptrajFile_CpptrajFile), 1); if (unlikely(!__pyx_ptype_6pytraj_11CpptrajFile_CpptrajFile)) {__pyx_filename = __pyx_f[25]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_8DataFile_DataFile = __Pyx_ImportType("pytraj.DataFile", "DataFile", sizeof(struct __pyx_obj_6pytraj_8DataFile_DataFile), 1); if (unlikely(!__pyx_ptype_6pytraj_8DataFile_DataFile)) {__pyx_filename = __pyx_f[26]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_12DataFileList_DataFileList = __Pyx_ImportType("pytraj.DataFileList", "DataFileList", sizeof(struct __pyx_obj_6pytraj_12DataFileList_DataFileList), 1); if (unlikely(!__pyx_ptype_6pytraj_12DataFileList_DataFileList)) {__pyx_filename = __pyx_f[27]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_6pytraj_12trajs_dot_Trajin_Trajin = __Pyx_ImportType("pytraj.trajs.Trajin", "Trajin", sizeof(struct __pyx_obj_6pytraj_12trajs_dot_Trajin_Trajin), 1); if (unlikely(!__pyx_ptype_6pytraj_12trajs_dot_Trajin_Trajin)) {__pyx_filename = __pyx_f[20]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_10Trajectory_Trajectory = __Pyx_ImportType("pytraj.Trajectory", "Trajectory", sizeof(struct __pyx_obj_6pytraj_10Trajectory_Trajectory), 1); if (unlikely(!__pyx_ptype_6pytraj_10Trajectory_Trajectory)) {__pyx_filename = __pyx_f[29]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_6pytraj_10ActionList_ActionList = __Pyx_ImportType("pytraj.ActionList", "ActionList", sizeof(struct __pyx_obj_6pytraj_10ActionList_ActionList), 1); if (unlikely(!__pyx_ptype_6pytraj_10ActionList_ActionList)) {__pyx_filename = __pyx_f[31]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_6pytraj_12AnalysisList_AnalysisList = __Pyx_ImportType("pytraj.AnalysisList", "AnalysisList", sizeof(struct __pyx_obj_6pytraj_12AnalysisList_AnalysisList), 1); if (unlikely(!__pyx_ptype_6pytraj_12AnalysisList_AnalysisList)) {__pyx_filename = __pyx_f[33]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_12CpptrajState_CpptrajState = __Pyx_ImportType("pytraj.CpptrajState", "CpptrajState", sizeof(struct __pyx_obj_6pytraj_12CpptrajState_CpptrajState), 1); if (unlikely(!__pyx_ptype_6pytraj_12CpptrajState_CpptrajState)) {__pyx_filename = __pyx_f[34]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         trajin_text = trajin_text.encode()
 */
  __pyx_t_1 = __Pyx_GetNameInClass((PyObject *)__pyx_ptype_6pytraj_7Command_Command, __pyx_n_s_get_state); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);

  /* "pytraj/Command.pyx":25
 *         del self.thisptr
 * 
 *     @classmethod             # <<<<<<<<<<<<<<
 *     def get_state(cls, trajin_text):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem((PyObject *)__pyx_ptype_6pytraj_7Command_Command->tp_dict, __pyx_n_s_get_state, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
