 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyString_Format(__pyx_kp_s_Box_with_x_y_z_alpha_beta_gamma, __pyx_v_boxlisttxt); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
