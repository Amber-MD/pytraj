...
#endif
{
  ...
  __pyx_ptype_6pytraj_4core_10TrajinList_TrajinList = __Pyx_ImportType("pytraj.core.TrajinList", "TrajinList", sizeof(struct __pyx_obj_6pytraj_4core_10TrajinList_TrajinList), 1); if (unlikely(!__pyx_ptype_6pytraj_4core_10TrajinList_TrajinList)) {__pyx_filename = __pyx_f[28]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
