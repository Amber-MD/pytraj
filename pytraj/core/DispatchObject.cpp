...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initDispatchObject(void); /*proto*/
PyMODINIT_FUNC initDispatchObject(void)
#else
PyMODINIT_FUNC PyInit_DispatchObject(void); /*proto*/
PyMODINIT_FUNC PyInit_DispatchObject(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_DispatchObject(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("DispatchObject", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
