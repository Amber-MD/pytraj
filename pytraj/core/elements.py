...
mass_atomic_number_dict = dict((atomic_number, mass) for (atomic_number, mass)
                               in zip(atomic_number_arr, mass_arr))

mass_element_dict = dict((atom_element, mass) for (atom_element, mass)
                         in zip(atom_element_arr, mass_arr))
