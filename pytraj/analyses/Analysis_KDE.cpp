...
static void __pyx_tp_dealloc_6pytraj_8analyses_12Analysis_KDE_Analysis_KDE(PyObject *o) {
  ...
  if (likely(__pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis)) __pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis->tp_dealloc(o); else __Pyx_call_next_tp_dealloc(o, __pyx_tp_dealloc_6pytraj_8analyses_12Analysis_KDE_Analysis_KDE);
}
...
#endif
{
  ...
  __pyx_type_6pytraj_8analyses_12Analysis_KDE_Analysis_KDE.tp_base = __pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis;
