...
static void __pyx_tp_dealloc_6pytraj_8analyses_16Analysis_AmdBias_Analysis_AmdBias(PyObject *o) {
  ...
  if (likely(__pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis)) __pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis->tp_dealloc(o); else __Pyx_call_next_tp_dealloc(o, __pyx_tp_dealloc_6pytraj_8analyses_16Analysis_AmdBias_Analysis_AmdBias);
}
...
#endif
{
  ...
  __pyx_type_6pytraj_8analyses_16Analysis_AmdBias_Analysis_AmdBias.tp_base = __pyx_ptype_6pytraj_17analyses_dot_Analysis_Analysis;
