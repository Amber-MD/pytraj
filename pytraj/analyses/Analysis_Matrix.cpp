...
/* "pytraj/analyses/Analysis_Matrix.pxd":14
 * 
 * 
...
/* "pytraj/analyses/Analysis_Matrix.pyx":4
 * 
 * cdef class Analysis_Matrix (Analysis):
 *     def __cinit__(self):             # <<<<<<<<<<<<<<
...
static int __pyx_pf_6pytraj_8analyses_15Analysis_Matrix_15Analysis_Matrix___cinit__(struct __pyx_obj_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix *__pyx_v_self) {
  ...
  /* "pytraj/analyses/Analysis_Matrix.pyx":5
 * cdef class Analysis_Matrix (Analysis):
 *     def __cinit__(self):
 *         self.baseptr = <_Analysis*> new _Analysis_Matrix()             # <<<<<<<<<<<<<<
 *         self.thisptr = <_Analysis_Matrix*> self.baseptr
...
static void __pyx_pf_6pytraj_8analyses_15Analysis_Matrix_15Analysis_Matrix_2__dealloc__(struct __pyx_obj_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix *__pyx_v_self) {
  ...
  /* "pytraj/analyses/Analysis_Matrix.pyx":9
 * 
 *     def __dealloc__(self):
 *         if self.baseptr is not NULL:             # <<<<<<<<<<<<<<
 *             del self.baseptr
...
static PyObject *__pyx_pf_6pytraj_8analyses_15Analysis_Matrix_15Analysis_Matrix_4alloc(struct __pyx_obj_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix *__pyx_v_self) {
  ...
  /* "pytraj/analyses/Analysis_Matrix.pyx":15
 *         """return a function-pointer object to be used with AnalysisList class
 *         """
 ...
 *         return func
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)__pyx_ptype_6pytraj_4core_9_FunctPtr_FunctPtr)), __pyx_empty_tuple, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_func = ((struct __pyx_obj_6pytraj_4core_9_FunctPtr_FunctPtr *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "pytraj/analyses/Analysis_Matrix.pyx":16
 *         """
 *         cdef FunctPtr func = FunctPtr()
 *         func.ptr = &(self.thisptr.Alloc)             # <<<<<<<<<<<<<<
 *         return func
...
static PyObject *__pyx_pf_6pytraj_8analyses_15Analysis_Matrix_15Analysis_Matrix_6help(struct __pyx_obj_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix *__pyx_v_self) {
  ...
  /* "pytraj/analyses/Analysis_Matrix.pyx":20
 * 
 *     def help(self):
 *         self.thisptr.Help()             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  if (PyType_Ready(&__pyx_type_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 3; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Analysis_Matrix", (PyObject *)&__pyx_type_6pytraj_8analyses_15Analysis_Matrix_Analysis_Matrix) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 3; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
