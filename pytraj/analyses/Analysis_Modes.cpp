...
#endif
#include <math.h>
#define __PYX_HAVE__pytraj__analyses__Analysis_Modes
#define __PYX_HAVE_API__pytraj__analyses__Analysis_Modes
#include "string.h"
#include <string>
#include "ios"
#include "new"
...
static const char *__pyx_f[] = {
  "pytraj/analyses/Analysis_Modes.pyx",
  "pytraj/Frame.pxd",
  "stringsource",
...
struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes;
...
/* "pytraj/analyses/Analysis_Modes.pxd":26
 * 
 * 
...
/* Module declarations from 'pytraj.analyses.Analysis_Modes' */
static PyTypeObject *__pyx_ptype_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes = 0;
...
#define __Pyx_MODULE_NAME "pytraj.analyses.Analysis_Modes"
int __pyx_module_is_main_pytraj__analyses__Analysis_Modes = 0;

/* Implementation of 'pytraj.analyses.Analysis_Modes' */
...
static int __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes___cinit__(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self); /* proto */
static void __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_2__dealloc__(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_4alloc(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_6help(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self); /* proto */
...
static PyObject *__pyx_tp_new_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* "pytraj/analyses/Analysis_Modes.pyx":6
 * 
 * cdef class Analysis_Modes (Analysis):
 *     def __cinit__(self):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static int __pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  ...
  __pyx_r = __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes___cinit__(((struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *)__pyx_v_self));
...
static int __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes___cinit__(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__", 0);

  /* "pytraj/analyses/Analysis_Modes.pyx":7
 * cdef class Analysis_Modes (Analysis):
 *     def __cinit__(self):
 *         self.baseptr = <_Analysis*> new _Analysis_Modes()             # <<<<<<<<<<<<<<
 *         self.thisptr = <_Analysis_Modes*> self.baseptr
 * 
 */
  __pyx_v_self->__pyx_base.baseptr = ((Analysis *)new Analysis_Modes());

  /* "pytraj/analyses/Analysis_Modes.pyx":8
 *     def __cinit__(self):
 *         self.baseptr = <_Analysis*> new _Analysis_Modes()
 *         self.thisptr = <_Analysis_Modes*> self.baseptr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_self->thisptr = ((Analysis_Modes *)__pyx_v_self->__pyx_base.baseptr);
...
/* "pytraj/analyses/Analysis_Modes.pyx":10
 *         self.thisptr = <_Analysis_Modes*> self.baseptr
 * 
 *     def __dealloc__(self):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static void __pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_2__dealloc__(((struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_2__dealloc__(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("__dealloc__", 0);

  /* "pytraj/analyses/Analysis_Modes.pyx":11
 * 
 *     def __dealloc__(self):
 *         if self.baseptr is not NULL:             # <<<<<<<<<<<<<<
 *             del self.baseptr
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pytraj/analyses/Analysis_Modes.pyx":12
 *     def __dealloc__(self):
 *         if self.baseptr is not NULL:
 *             del self.baseptr             # <<<<<<<<<<<<<<
 * 
...
/* "pytraj/analyses/Analysis_Modes.pyx":14
 *             del self.baseptr
 * 
 *     def alloc(self):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_5alloc(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_4alloc[] = "Analysis_Modes.alloc(self)\nreturn a function-pointer object to be used with AnalysisList class\n        ";
static PyObject *__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_5alloc(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("alloc (wrapper)", 0);
  __pyx_r = __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_4alloc(((struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *)__pyx_v_self));
...
static PyObject *__pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_4alloc(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self) {
  ...
  /* "pytraj/analyses/Analysis_Modes.pyx":17
 *         """return a function-pointer object to be used with AnalysisList class
 *         """
 ...
 */
  ...
  /* "pytraj/analyses/Analysis_Modes.pyx":18
 *         """
 *         cdef FunctPtr func = FunctPtr()
 *         func.ptr = &(self.thisptr.Alloc)             # <<<<<<<<<<<<<<
 *         return func
 ...
 */
  ...
  /* "pytraj/analyses/Analysis_Modes.pyx":19
 *         cdef FunctPtr func = FunctPtr()
 *         func.ptr = &(self.thisptr.Alloc)
 *         return func             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pytraj.analyses.Analysis_Modes.Analysis_Modes.alloc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "pytraj/analyses/Analysis_Modes.pyx":21
 *         return func
 * 
 *     def help(self):             # <<<<<<<<<<<<<<
 *         self.thisptr.Help()
...
/* Python wrapper */
static PyObject *__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_7help(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_6help[] = "Analysis_Modes.help(self)";
static PyObject *__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_7help(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("help (wrapper)", 0);
  __pyx_r = __pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_6help(((struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *)__pyx_v_self));
...
static PyObject *__pyx_pf_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_6help(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("help", 0);

  /* "pytraj/analyses/Analysis_Modes.pyx":22
 * 
 *     def help(self):
 *         self.thisptr.Help()             # <<<<<<<<<<<<<<
 */
...
static PyObject *__pyx_tp_new_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o = __pyx_ptype_6pytraj_8analyses_8Analysis_Analysis->tp_new(t, a, k);
  if (unlikely(!o)) return 0;
  if (unlikely(__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes(PyObject *o) {
  ...
  #endif
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_3__dealloc__(o);
    --Py_REFCNT(o);
    PyErr_Restore(etype, eval, etb);
  }
  if (likely(__pyx_ptype_6pytraj_8analyses_8Analysis_Analysis)) __pyx_ptype_6pytraj_8analyses_8Analysis_Analysis->tp_dealloc(o); else __Pyx_call_next_tp_dealloc(o, __pyx_tp_dealloc_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes);
}

static PyMethodDef __pyx_methods_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes[] = {
  {"alloc", (PyCFunction)__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_5alloc, METH_NOARGS, __pyx_doc_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_4alloc},
  {"help", (PyCFunction)__pyx_pw_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_7help, METH_NOARGS, __pyx_doc_6pytraj_8analyses_14Analysis_Modes_14Analysis_Modes_6help},
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes = {
  PyVarObject_HEAD_INIT(0, 0)
  "pytraj.analyses.Analysis_Modes.Analysis_Modes", /*tp_name*/
  sizeof(struct __pyx_obj_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "pytraj.analyses.Analysis_Modes.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pytraj.analyses.Analysis_Modes.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pytraj.analyses.Analysis_Modes.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pytraj.analyses.Analysis_Modes._memoryviewslice", /*tp_name*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initAnalysis_Modes(void); /*proto*/
PyMODINIT_FUNC initAnalysis_Modes(void)
#else
PyMODINIT_FUNC PyInit_Analysis_Modes(void); /*proto*/
PyMODINIT_FUNC PyInit_Analysis_Modes(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_Analysis_Modes(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Analysis_Modes", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pytraj__analyses__Analysis_Modes) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pytraj.analyses.Analysis_Modes")) {
      if (unlikely(PyDict_SetItemString(modules, "pytraj.analyses.Analysis_Modes", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes.tp_base = __pyx_ptype_6pytraj_8analyses_8Analysis_Analysis;
  if (PyType_Ready(&__pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Analysis_Modes", (PyObject *)&__pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes = &__pyx_type_6pytraj_8analyses_14Analysis_Modes_Analysis_Modes;
  ...
  /* "pytraj/analyses/Analysis_Modes.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pytraj.analyses.Analysis_Modes", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pytraj.analyses.Analysis_Modes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
