// Action_Mask_2
#include "Action_Mask_2.h"
#include "CpptrajStdio.h"
#include "Trajout.h"

// CONSTRUCTOR
Action_Mask_2::Action_Mask_2() :
  CurrentParm_(0),
  debug_(0),
...
// TODO : add internal data in DSL for pytraj
Action::RetType Action_Mask_2::Init(ArgList& actionArgs, TopologyList* PFL, DataSetList* DSL, DataFileList* DFL, int debugIn)
{
  debug_ = debugIn;
  // Get Keywords
...
// Action_Mask_2::Setup()
Action::RetType Action_Mask_2::Setup(Topology* currentParm, Topology** parmAddress) {
  CurrentParm_ = currentParm;
  return Action::OK;
}

// Action_Mask_2::DoAction()
Action::RetType Action_Mask_2::DoAction(int frameNum, Frame* currentFrame, Frame** frameAddress) {
  // Get atom selection
