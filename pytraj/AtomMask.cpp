 ...
 */
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_myview.data + __pyx_t_10 * __pyx_v_myview.strides[0]) )) = (__pyx_v_v[__pyx_v_i]);
 ...
 */
    ...
    __pyx_v_self->thisptr->AddSelectedAtom((*((int *) ( /* dim=0 */ (__pyx_v_int_view.data + __pyx_t_15 * __pyx_v_int_view.strides[0]) ))));
